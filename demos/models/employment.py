...
def employment(persons):
    ...
    **Modifies State Variables:**
    ...
    if module_config.simultaneous_calibration_config is not None:
        ...
        stay_unemployed_list = run_and_calibrate_in_workforce_model(persons, module_config.enter_model_calibration_procedure)
        exit_workforce_list = run_and_calibrate_out_workforce_model(persons, module_config.exit_model_calibration_procedure)
